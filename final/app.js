...
const images = [
  ...
  // content setup
  const texts = [
    ["new worlds", "a photo series — josh chen"],
  ];
  ...
  rgbKineticSlider = new rgbKineticSlider({
    ...
    cursorMomentum: 0.20, // lower is slower
    ...
    transitionScaleIntensity: 40, // scale intensity during transition
    ...
    googleFonts: ["Cormorant:700", "Roboto:400"], // select google font to use
    buttonMode: false, // enable button mode for title
    textsRgbEffect: true, // enable text rgb effect
    textsRgbIntensity: 0.02, // set text rgb intensity
