...
for (const track of tracks) {
  const template = `
    <div data-index="${songIndex}" onclick="playSong(event);">
...
// logic.
const playSong = (ev) => {
    const songToPlay = ev.currentTarget.dataset.index;
    document.querySelector('#audio-source').src = tracks[songToPlay].preview_url;
